...
function addForm() {
  ...
  append("<p class='check content-action click-button'>" +
    "<img src='/images/search.png' alt='Подробно' /></p>");
  $("#" + newId + " .content-actions").
...
function saveAsTemplate() {
    ...
    //Конвертация всего массива условий в стркоу
    // и сохранение этой строки в инпут
    var json_template = $("#json-template").val(JSON.stringify(JsonData));
